  ...
  theme: {
    extend: {
      colors: {
        ...
        brand: {
          ...
          gradient: {
            ...
            secondary: "linear-gradient(135deg, #1e40af 0%, #0e7490 100%)",
      ...
      backgroundImage: {
        ...
        "brand-gradient-dark": "linear-gradient(135deg, #1e40af 0%, #0e7490 100%)",
        "brand-gradient-light": "linear-gradient(135deg, #60a5fa 0%, #22d3ee 100%)",
      },
      animation: {
